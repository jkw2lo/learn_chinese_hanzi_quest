...
{c:"没",p:"méi",m:"not have; (mò) to sink",comp:["水","又"],pos:["adv","v"],story:"Water (氵) closing over a hand (又) — something going under and out of sight. What is gone is what you haven't got: 没有.",o:"氵 water with 殳, a hand holding a tool. To sink or drown; from 'vanished' came the plain negative for having.",words:[["没有","méiyǒu","to not have; there isn't"],["没事","méishì","it's nothing; never mind"],["没什么","méi shénme","nothing much"]],sent:["我没有钱。","Wǒ méiyǒu qián.","I don't have any money."]},
{c:"哪",p:"nǎ",m:"which; where",comp:["口","那"],pos:["part-q"],story:"那 that, with a mouth (口) added to ask about it. 那 points; 哪 asks which one you mean.",o:"口 mouth beside 那 for sound. The mouth radical marks a great many question words and particles.",words:[["哪个","nǎge","which one"],["哪里","nǎli","where"],["哪儿","nǎr","where (northern)"]],sent:["你在哪里？","Nǐ zài nǎli?","Where are you?"]},
{c:"怎",p:"zěn",m:"how",comp:["心"],pos:["part-q"],story:"乍 suddenly, over a heart (心) — the jolt of not knowing what to do. That is the question 怎么.",o:"心 heart with 乍 for sound. A late character, built for the spoken question rather than inherited from the classics.",words:[["怎么","zěnme","how"],["怎么样","zěnmeyàng","how about it?; how is it?"],["怎么办","zěnme bàn","what do we do?"]],sent:["这个怎么说？","Zhège zěnme shuō?","How do you say this?"]},
{c:"吧",p:"ba",m:"(softening suggestion marker)",comp:["口"],pos:["part"],story:"A mouth (口) with 巴 for sound. Tacked on the end it turns an order into an invitation: 走 go, 走吧 let's go.",o:"口 mouth plus 巴. Purely a sound borrowing — the character carries none of the meaning, only the noise.",words:[["走吧","zǒu ba","let's go"],["好吧","hǎo ba","all right then"],["来吧","lái ba","come on"]],sent:["我们走吧。","Wǒmen zǒu ba.","Let's go."]}
);
HQ.push(
...
{c:"第",p:"dì",m:"(ordinal prefix)",comp:["弟"],pos:["num"],story:"Put it in front of a number and the number becomes a position: 一 one, 第一 first. It does nothing else.",o:"⺮ bamboo over 弟 younger brother — bamboo strips bound in order, which is how a sequence was recorded.",words:[["第一","dì yī","first"],["第二","dì èr","second"],["第三","dì sān","third"]],sent:["这是第一次。","Zhè shì dì yī cì.","This is the first time."]},
{c:"金",p:"jīn",m:"gold; metal",comp:["人","王","土"],pos:["n"],story:"Nuggets in the earth under a roof of ore. Squeezed to 钅 it becomes the metal radical, standing on the left of 钱, 铁 and 银.",o:"Specks of metal in the ground beneath 今 for sound. Gold first, then metal in general, then the radical for anything made of it.",words:[["现金","xiànjīn","cash"],["金子","jīnzi","gold"],["金鱼","jīnyú","goldfish"]],sent:["我没有现金。","Wǒ méiyǒu xiànjīn.","I don't have any cash."]}
);
HQ.push(
...
{c:"儿",p:"ér",m:"child; son",comp:[],pos:["n"],story:"A child drawn with an open fontanelle — the soft gap in a baby's skull. In the north it also sticks to the end of words as a curl of the tongue: 这儿, 那儿.",o:"A pictograph of a child with the top of the head still unclosed. The same legs appear under 见 and 先.",words:[["儿子","érzi","son"],["女儿","nǚ'ér","daughter"],["这儿","zhèr","here (northern)"]],sent:["他有一个儿子。","Tā yǒu yí gè érzi.","He has one son."]},
{c:"孩",p:"hái",m:"child",comp:["子"],pos:["n"],story:"A child (子) with 亥 for sound. Where 儿 is your own son, 孩子 is any child at all.",o:"子 child beside 亥, the twelfth earthly branch, used purely for its sound.",words:[["孩子","háizi","child"],["女孩","nǚhái","girl"],["男孩","nánhái","boy"]],sent:["那个孩子很小。","Nàge háizi hěn xiǎo.","That child is very small."]},
{c:"先",p:"xiān",m:"first; earlier",comp:["土"],pos:["adv"],story:"A foot stepping out ahead of a person (儿) — whoever is in front. 先生 'born first' is how you address a man.",o:"A footprint above 儿 a person: going before. From walking ahead came earlier in time, and then seniority.",words:[["先生","xiānsheng","Mr; sir; husband"],["首先","shǒuxiān","first of all"],["先走","xiān zǒu","to leave first"]],sent:["我先走了。","Wǒ xiān zǒu le.","I'm off first."]},
{c:"岁",p:"suì",m:"year of age",comp:["山"],pos:["mw"],story:"Counting years, not dates: 三岁 is three years old. The question is 几岁 or 多大.",o:"The full form 歲 is a blade and two steps — the passage of a harvest year. Simplified to 山 over 夕, a mountain and a dusk.",words:[["几岁","jǐ suì","how old (of a child)"],["十岁","shí suì","ten years old"],["岁月","suìyuè","the years; time"]],sent:["他今年八岁。","Tā jīnnián bā suì.","He is eight this year."]},
{c:"间",p:"jiān",m:"between; room",comp:["门","日"],pos:["n","mw"],story:"Sunlight (日) coming through a gate (门) — the gap between the doors. A space between things, and then a room.",o:"門 gate with 日 sun showing through the crack. The older form had 月 moonlight instead, which is the same idea at night.",words:[["时间","shíjiān","time"],["房间","fángjiān","room"],["中间","zhōngjiān","in the middle"]],sent:["我没有时间。","Wǒ méiyǒu shíjiān.","I don't have time."]},
{c:"气",p:"qì",m:"air; energy; anger",comp:["人"],pos:["n"],story:"Three drifting lines of vapour. One of the oldest ideas in the language: breath, steam, weather, mood, and the energy that runs through all of them.",o:"A drawing of rising vapour. The full form 氣 adds 米 rice — steam off cooking grain, which is where the sense of nourishing energy comes from.",words:[["天气","tiānqì","weather"],["生气","shēngqì","to get angry"],["空气","kōngqì","air"]],sent:["今天天气很好。","Jīntiān tiānqì hěn hǎo.","The weather is lovely today."]}
);
...
{c:"京",p:"jīng",m:"capital city",comp:["小","口"],pos:["n"],story:"A tall building on a mound, drawn tall. 北京 is the northern capital; 南京 the southern one.",o:"A high structure on an artificial hill — the seat of a ruler. Height and rule were the same drawing.",words:[["北京","Běijīng","Beijing"],["南京","Nánjīng","Nanjing"],["京城","jīngchéng","the capital"]],sent:["我住在北京。","Wǒ zhù zài Běijīng.","I live in Beijing."]},
{c:"床",p:"chuáng",m:"bed",comp:["木"],pos:["n"],story:"Wood (木) under a lean-to roof (广) — a wooden frame indoors. 起床 to get up is literally to rise from it.",o:"广 a roofed structure over 木 wood. The older form 牀 puts the wood on the right; both are a plank you lie on.",words:[["起床","qǐchuáng","to get up"],["床上","chuángshang","in bed"],["一张床","yì zhāng chuáng","a bed"]],sent:["我七点起床。","Wǒ qī diǎn qǐchuáng.","I get up at seven."]},
{c:"桌",p:"zhuō",m:"table; desk",comp:["木","日","早"],pos:["n"],story:"Wood (木) under 卓 'tall' — a raised wooden surface. That is a table, and the measure word for a tableful of food.",o:"卓 outstanding or elevated, over 木 wood. Something wooden and raised off the floor.",words:[["桌子","zhuōzi","table"],["书桌","shūzhuō","desk"],["一桌菜","yì zhuō cài","a table of dishes"]],sent:["书在桌子上。","Shū zài zhuōzi shang.","The book is on the table."]},
{c:"力",p:"lì",m:"strength; power",comp:[],pos:["n"],story:"A ploughing tool, or an arm flexed — sources disagree. Either way it is effort applied, and it sits inside 动, 男 and 办.",o:"Most likely a plough seen from the side. Physical effort first, then ability and power of any kind.",words:[["努力","nǔlì","to work hard"],["力气","lìqi","physical strength"],["有力","yǒulì","forceful"]],sent:["他很努力。","Tā hěn nǔlì.","He works very hard."]},
);
...
const STAGES = [
  ...
  {n:2, icon:"🌿", name:"Sprout",   zh:"发芽", end:50,  core:true,  blurb:"Pronouns, to-be, negation, questions."},
  {n:3, icon:"🍃", name:"Branch",   zh:"枝叶", end:80,  core:true,  blurb:"Everyday verbs and time words."},
  {n:4, icon:"🥉", name:"Explorer", zh:"探索", end:117, core:true,  blurb:"Numbers, money, directions, shops."},
  {n:5, icon:"🥈", name:"Everyday", zh:"日常", end:163, core:true,  blurb:"People, time, feelings."},
  {n:6, icon:"🍜", name:"Kitchen",  zh:"厨房", end:190, core:false, blurb:"Food, drink and everything on a menu."},
  {n:7, icon:"📖", name:"Reader",   zh:"阅读", end:253, core:true,  blurb:"Numbers, connectives and the grammar that joins characters into sentences."},
  {n:8, icon:"🏙️", name:"The World", zh:"世界", end:318, core:true,  blurb:"The body, colours, weather, buildings — the physical world you read about."},
  {n:9, icon:"💬", name:"Connect",  zh:"交流", end:364, core:true,  blurb:"Language, study, screens, and the words for thinking and remembering."}
];
